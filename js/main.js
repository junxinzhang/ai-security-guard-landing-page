/**
 * AI Security Guard - Landing Page JavaScript
 */
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Observe threat stats for animation
  const threatStats = document.querySelectorAll('[data-counter]');
  if ('IntersectionObserver' in window && threatStats.length > 0) {
    ...
    threatStats.forEach(stat => counterObserver.observe(stat));
  }

  // Console welcome message
  console.log('%cAI Security Guard', 'color: #3b82f6; font-size: 20px; font-weight: bold;');
  console.log('%cAI-Powered Security Protection Platform', 'color: #64748b; font-size: 12px;');
});
